...
def main():
    parser = argparse.ArgumentParser(
        description="Simple command line with GPT-3.5-turbo")
    ...
    initial_prompt = f"You are Linux OS terminal. Your personality is: {
        args.personality}"
    ...
    while True:
        ...
        try:
            ...
            if "PING" in message["content"]:
                ...
                messages.append(
                    {"role": "user", "content": user_input + f"\t<{datetime.now()}>\n"})
